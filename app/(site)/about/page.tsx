...
import {Portrait,PhotoGallery} from '@/components/portrait';
...
const methods=['Qualitative case study','Theory-driven analysis (RSCT)','Process tracing','Document & discourse analysis','Practitioner reflection','SPSS','Research ethics · NIH training'];

export default async function About(){
 const {portrait,photos}=await getProfileMedia();
 return <>
  <section className="wrap about-hero">
   <div className="stack" style={{gap:14}}>
    <Portrait photo={portrait} variant="about" hint={showPhotoHints} priority/>
  ...
  <section className="wrap section" aria-labelledby="route-title">
   <div className="section-head"><div className="stack"><span className="label designator live">J1 · The route so far</span><h2 id="route-title" className="h-section">Five places, one line of inquiry.</h2></div></div>
   <RouteTrace/>
