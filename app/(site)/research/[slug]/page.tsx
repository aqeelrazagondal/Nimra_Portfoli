...
export default async function Project({params}:{params:Promise<{slug:string}>}){
 ...
 const sections=[['abstract','Abstract'],['question','The question'],['argument','The argument'],['approach','Approach'],...(p.findings.length?[['findings',p.findingsTitle]]:[]),['next','Why it matters & what comes next']] as const;
 ...
 return <article>
  ...
  <div className="wrap detail-grid">
   <div className="detail-main">
    ...
    <section id="approach" className="detail-block"><span className="label">{n('approach')} · Approach</span><p className="reading">{p.method}</p></section>
