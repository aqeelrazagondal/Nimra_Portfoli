 ...
 return <>
  <section className="wrap teach-hero">
   <div className="stack" style={{gap:28}}>
    <span className="label">U4 · Teaching · Inclusion &amp; practice</span>
    <h1 className="h-page">Understanding begins <em>with belonging.</em></h1>
    ...
    <div className="btn-row"><a href="#experience" className="btn">Teaching experience</a><Link href="/cv" className="btn-ghost">Full CV</Link></div>
   </div>
  ...
  <section className="wrap section split" aria-labelledby="philosophy-title">
   <div className="split-head"><span className="label">J1 · Philosophy</span><h2 id="philosophy-title" className="h-section" style={{fontSize:'clamp(1.9rem,3vw,2.75rem)'}}>My approach to the classroom.</h2></div>
  ...
  <section id="experience" className="wrap section" aria-labelledby="experience-title" style={{scrollMarginTop:104}}>
   <div className="section-head"><div className="stack"><span className="label designator live">J2 · Teaching experience</span><h2 id="experience-title" className="h-section">Four roles, two countries.</h2></div></div>
   <ol className="roles" style={{listStyle:'none',margin:0,padding:0}}>
    {teaching.map(t=><li key={t.title} className="role">
     ...
     <div className="role-body"><h3 className="h-item">{t.title}</h3><span style={{fontSize:15,color:'var(--current)'}}>{t.institution}</span><ul>{t.points.map(x=><li key={x.slice(0,30)}>{x}</li>)}</ul></div>
    </li>)}
   </ol>
  </section>
  ...
  <section className="wrap section duo" aria-label="University teaching and specialisms" style={{alignItems:'start'}}>
   <div className="card" style={{borderRadius:28}}>
    <span className="label label-muted">J3 · University teaching · University of Gujrat</span>
   ...
   <div className="card" style={{borderRadius:28}}>
    <span className="label label-muted">J4 · Specialisms</span>
