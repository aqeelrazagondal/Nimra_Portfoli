...
export default async function NotFound(){const writing=(await getArticles()).length>0;return <><a className="skip" href="#main">Skip to content</a><Header writing={writing}/><main id="main"><section className="page-section"><p className="eyebrow">404 / PAGE NOT FOUND</p><h1>A different direction.</h1><p>This page could not be found.</p><Link href="/" className="button">Back to home →</Link></section></main><Footer writing={writing} year={new Date().getFullYear()}/></>}
