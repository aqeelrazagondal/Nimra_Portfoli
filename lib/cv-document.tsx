...
Font.register({family:'Inter',fonts:[{src:font('Inter-Regular.ttf')},{src:font('Inter-Medium.ttf'),fontWeight:500},{src:font('Inter-SemiBold.ttf'),fontWeight:600}]});
...
const styles=StyleSheet.create({
 page:{paddingTop:44,paddingBottom:56,paddingHorizontal:52,fontFamily:'Inter',fontSize:9,color:c.text},
 ...
 dates:{width:104,paddingRight:10,fontSize:8,lineHeight:1.45,color:c.muted,paddingTop:1.5},
 body:{flex:1},
